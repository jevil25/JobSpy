...
class Glassdoor(Scraper):
    ...
    def scrape(self, scraper_input: ScraperInput) -> JobResponse:
        ...
        headers["user-agent"] = self.user_agent or "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3"
        self.session.headers.update(headers)

        print(f"Glassdoor: location: {scraper_input.location}, ")
    ...
    def _get_location(self, location: str, is_remote: bool) -> (int, str):
        ...
        print(f"Glassdoor: fetching location for {url}")
